...
operators.date = function(searchFields, querystring, field) {
  var dateParameters = {};
  var query;
  ...
  if (query.start || query.end) {
    ...
    if (query.start) {
      ...
      if (typeof query.start === 'object') {
        ...
        dateStart = moment.utc([
          dateParameters.start.years,
          dateParameters.start.months,
          dateParameters.start.days,
          dateParameters.start.hours,
          dateParameters.start.minutes,
          dateParameters.start.seconds
        ]);
    ...
    if (query.end) {
      ...
      if (typeof query.end === 'object') {
        ...
        dateEnd = moment.utc([
          dateParameters.end.years,
          dateParameters.end.months,
          dateParameters.end.days,
          dateParameters.end.hours,
          dateParameters.end.minutes,
          dateParameters.end.seconds
        ]);
    ...
    // e.g. (3, 'months') gives "3 months before currentDate"
    var rangeStart = moment().subtract(query.range, query.units);
    // e.g. (3, 'months') gives "3 months after currentDate"
    var rangeEnd = moment().add(query.range, query.units);
...
operators.filter = function(searchFields, querystring, field) {
  var query;
...
operators.order = function(searchFields, querystring, field) {
  var query;
