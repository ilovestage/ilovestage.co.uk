...
echo "Restart application on Amazon EC2 instance via PM2 stop follow by PM2 restart:"
ssh -i ~/.ssh/karl.pem ubuntu@ilovestage.co.uk "pm2 stop all && pm2 restart all"
